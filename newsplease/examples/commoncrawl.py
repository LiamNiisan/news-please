...
# keywords inside html text (if None, any article will be downloaded)
my_filter_initial_keywords = [
    "landslide",
    "mudslide",
    "slope failure",
    "debris flow",
...
# keywords not inside html text (if None, any article will be downloaded)
my_filter_not_initial_keywords = [
    "politics",
    "election",
    "political",
    "defeat",
...
my_filter_start_date = datetime.datetime(2019, 1, 1)  # datetime.datetime(2016, 1, 1)
...
my_number_of_extraction_processes = 6
...
def main():
    ...
    commoncrawl_crawler.crawl_from_commoncrawl(
        ...
        filter_initial_keywords=my_filter_initial_keywords,
        filter_not_initial_keywords=my_filter_not_initial_keywords,
        filter_lang=my_filter_lang,
